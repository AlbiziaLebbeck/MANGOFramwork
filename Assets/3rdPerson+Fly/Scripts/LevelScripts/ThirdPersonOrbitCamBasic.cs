...
public class ThirdPersonOrbitCamBasic : MonoBehaviour
{
    ...
    public void CamInit()
    {
        ...
        smoothCamOffset = camOffset;
        // defaultFOV = cam.GetComponent<Camera>().fieldOfView;
        defaultFOV = PlayerCameraHandler.Instance.MainVirtualCamera.m_Lens.FieldOfView;
        angleH = player.eulerAngles.y;
    ...
    void Update()
    {
        ...
        var virtualCamera = PlayerCameraHandler.Instance.MainVirtualCamera;
        var lens = virtualCamera.m_Lens;
        lens.FieldOfView = Mathf.Lerp(lens.FieldOfView, targetFOV, Time.deltaTime);
